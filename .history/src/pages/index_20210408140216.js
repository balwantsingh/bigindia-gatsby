...
const IndexPage = () => (
  <Layout>
    ...
    <div class="flex px-10">
      <div class="w-1/5 border shadow p-5 mr-5 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
        <p>Image</p>
        <p class="block font-semibold hover:underline text-gray-700 my-2">Product Title</p>
        <p class="text-sm text-gray-700 capitalize">Company</p>
        <p class="text-sm text-gray-700 capitalize">Location</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-10 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
        <p>Image</p>
        <p>Product Title</p>
        <p>Company</p>
        <p>Location</p>
