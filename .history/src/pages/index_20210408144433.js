        ...
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2">
                  <div class="no-underline hover:underline text-gray-700 font-semibold text-xl">Get quotations from the most reputed suppliers</div>
                  <a class="inline-flex truncate getStarted font-semibold px-5 pt-3 pb-2 rounded outline-none focus:outline-none mr-5 text-white border text-lg shadow hover:shadow-xl" target="_blank" rel="noopener noreferrer" aria-label="become a seller"><span class="text-2xl mr-2"><ion-icon name="people-outline"></ion-icon></span>Become a seller</a>
                </h1>
              </div>
            </header>
          </article>
