      ...
      <div class="block">
        <div class="md:max-w-4xl mx-auto over-hidden">
          <div class="p-7">
            ...
            <footer class="mt-10 mx-auto flex text-gray-700 leading-none p-2 md:p-4 text-center gap-x-48">
                <div class="text-center border">
                  <p class="text-lg text-gray-600">Trusted Platform</p>
                </div>
                <div class="text-center">

                  <p class="text-lg text-gray-600">Safe & Secure</p>
                </div>
                <div class="text-center">

                  <p class="text-lg text-gray-600">Quick Assistance</p>
                </div>
              </footer>
          </div>
        </div>
