...
const IndexPage = () => (
  <Layout>
          ...
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div class="text-gray-700 border-r border-gray-300 p-10 mt-5">
                <h1 class="ml-3 -mt-2">
                  <div class="no-underline hover:underline text-gray-700 font-semibold text-xl">Image here</div>
                </h1>
              </div>
            </header>
          </article>
        ...
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div class="text-gray-700 border-r border-gray-300 p-10 mt-5">
                <h1 class="ml-3 -mt-2">
                  <div class="text-lg mb-7">Get quotations from the most reputed suppliers</div>
        ...
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div class="text-gray-700 border-r border-gray-300 p-10 mt-5">
                <h1 class="ml-3 -mt-2">
                  <div class="text-lg mb-7">Most Recent RFQs from leading Companies</div>
                  <Link to="https://crm.bigindia.com/rfq-forms/create">
                  <a
                    className="text-gray-800 font-semibold px-5 py-3 rounded outline-none focus:outline-none mr-3 mb-1 hover:bg-orange-300 bg-gray-100 text-md border border-gray-400 hover:shadow-lg"
                    target="_blank"
    ...
    <h5 class="text-xl font-bold uppercase text-gray-700 text-center mb-5 hover:underline hover:text-blue-500 mt-10">Browse by Companies</h5>
