...
import `/product1.jpg` from "../images/`/product1.jpg`.jpg"
...
import `/product1.jpg`0 from "../images/`/product1.jpg`0.jpg"
  ...
  <Layout>
    ...
    <div class="flex px-10">
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
        <p>
          <img src={`/product1.jpg`} alt="Product1" class="productImage" />
        </p>
