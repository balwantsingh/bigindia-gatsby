...
const IndexPage = () => (
  <Layout>
    ...
    <div class="flex px-10">
      <div class="w-1/5 border shadow p-5 mr-5 overflow-hidden rounded-lg border py-2 shadow transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
        <p>Image</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-5">
        <p>Image</p>
        <p>Product Title</p>
        <p>Company</p>
        <p>Location</p>
