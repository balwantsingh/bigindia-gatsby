        ...
        <div class="w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/2">
          ...
          <ul class="list-none footer-links">
            ...
            <li class="mb-1">
              ...
              <footer class="footer-1 bg-white py-6 sm:py-6">
              ...
              <div class="sm:-mx-4 mt-2 sm:mt-2 sm:pt-2 "><div class="sm:w-full px-4 text-center">© 2021 bigindia.com. All rights reserved.</div></div>
              </div>
              </div>
