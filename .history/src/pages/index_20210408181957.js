  ...
  <Layout>
    ...
    <div class="flex px-10">
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
        <p><img src={product1} alt="Product1" class="productImage" /></p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product2} alt="Product2" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product3} alt="Product3" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product4} alt="Product4" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <p><img src={product5} alt="Product5" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
    ...
    <div class="flex px-10 mt-8">
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product6} alt="Product6" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product7} alt="Product7" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product8} alt="Product8" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product9} alt="Product9" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product10} alt="Product10" class="productImage" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="flex flex-wrap -mx-1 lg:-mx-4">
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
              <img src={company1} alt="dfdfgf" class="productImage2" />
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company2} alt="company2" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company3} alt="company3" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company4} alt="company4" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company5} alt="company5" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company6} alt="company6" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company7} alt="company7" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company8} alt="company8" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company9} alt="company9" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company10} alt="company10" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company11} alt="company11" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
                <h1 class="ml-3 -mt-2"><img src={company12} alt="company12" class="productImage2" /></h1>
              </div>
            </header>
          </article>
        </div>
