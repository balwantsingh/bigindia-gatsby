...
import agriculture from "../images/connect-buyer-seller.png"
import product1 from "../images/product1.jpeg"
import product2 from "../images/product1.jpeg"
import product3 from "../images/product1.jpeg"
import product4 from "../images/product1.jpeg"
import product5 from "../images/product1.jpeg"
import product6 from "../images/product1.jpeg"
import product7 from "../images/product1.jpeg"
import product8 from "../images/product1.jpeg"
import product9 from "../images/product1.jpeg"
import product10 from "../images/product1.jpeg"
  ...
  <Layout>
    ...
    <div class="flex px-10">
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
        <p><img src={product1} alt="Product1"  width="150" /></p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product2} alt="Product2"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product3} alt="Product3"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product4} alt="Product4"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <p><img src={product5} alt="Product5"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
    ...
    <div class="flex px-10 mt-8">
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product6} alt="Product6"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product7} alt="Product7"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product8} alt="Product8"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 mr-8 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product9} alt="Product9"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
      ...
      <div class="w-1/5 border shadow p-5 overflow-hidden rounded-lg py-2 transform transition duration-500 hover:scale-105 hover:shadow-xl hover:border-gray-400">
      <p><img src={product10} alt="Product10"  width="150" /></p>
        <p class="block font-semibold hover:underline text-gray-700 mt-2">
          Product Title
        </p>
        <p class="text-sm text-gray-700 capitalize my-1">Company</p>
