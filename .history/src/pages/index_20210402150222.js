  ...
  <div class="block">
    <div class="md:max-w-4xl mx-auto over-hidden">
      ...
      <div class="justify-between">
        <div class="text-7xl font-black text-indigo-600 text-center mb-8 leading-tight">BigIndia.com is a leading online marketplace connecting Buyers and Sellers</div>
        <p class="my-2 text-gray-400 text-lg text-center">Laravel is an open source, PHP based web application framework. We provide<br />a fast development approach for developing high quality Laravel web applications</p>
      <div>
    </div>
      </div>
      </div>
