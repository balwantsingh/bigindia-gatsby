        ...
        <div class="flex flex-wrap -mx-1 lg:-mx-4">
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={bengaluru} alt="company" class="productImage3 mb-3" />
                Bengaluru
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={ahmedabad} alt="company" class="productImage3 mb-3" />
                Ahmedabad
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={hyderabad} alt="company" class="productImage3 mb-3" />
                Hyderabad
                </div>
              </header>
            </article>
