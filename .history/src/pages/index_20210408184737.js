      ...
      <div class="flex flex-wrap -mx-1 lg:-mx-4">
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
              <img src={company1} alt="company" class="productImage2" />
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
              <img src={company2} alt="company" class="productImage2" />
              </div>
            </header>
          </article>
        </div>
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/6">
          <article class="overflow-hidden rounded-lg">
            <header class="flex">
              <div>
              <img src={company3} alt="company" class="productImage2" />
              </div>
            </header>
          </article>
        </div>
      ...
      <div class="mb-12 mx-auto px-4 md:px-12">
        <div class="flex flex-wrap -mx-1 lg:-mx-4">
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
                <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={delhi} alt="company" class="productImage2 mb-3" />
                Delhi
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={bengaluru} alt="company" class="productImage2 mb-3" />
                Bengaluru
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={chennai} alt="company" class="productImage2 mb-3" />
                Chennai
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={mumbai} alt="company" class="productImage2 mb-3" />
                Mumbai
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={ahmedabad} alt="company" class="productImage2 mb-3" />
                Ahmedabad
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={kolkata} alt="company" class="productImage2 mb-3" />
                Kolkata
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={pune} alt="company" class="productImage2 mb-3" />
                Pune
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={surat} alt="company" class="productImage2 mb-3" />
                Surat
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={jaipur} alt="company" class="productImage2 mb-3" />
                Jaipur
                </div>
              </header>
            </article>
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/5">
            <article class="overflow-hidden rounded-lg">
              <header class="flex">
              <div class="text-gray-700 p-10 mt-5 text-center text-lg">
                <img src={hyderabad} alt="company" class="productImage2 mb-3" />
                Hyderabad
                </div>
              </header>
            </article>
