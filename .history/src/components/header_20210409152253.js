...
const Header = ({ siteTitle }) => (
  ...
  <nav class="flex items-center bg-white py-4 px-10 flex-wrap mx-auto border-b">
    ...
    <Link to="https://wa.me/918287762654" target="_blank">
          <a
            className="fixed z-20 bottom-5 right-0  shadow-lg bgWhatsapp rounded-full float-right mr-8 -mt-60 w-16 h-16 text-4xl font-semibold text-white hover:bg-green-600 text-center transform transition duration-300 hover:scale-110 hover:shadow-xl text-center items-center justify-items-center"
