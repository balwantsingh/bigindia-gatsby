    ...
    >
      <div class="lg:inline-flex lg:flex-row lg:ml-auto flex flex-col text-xl">
        ...
        <span class="lg:inline-flex lg:w-auto w-auto px-5 py-2 rounded text-gray-500 hover:text-blue-600 hover:underline">
          ...
          <a href="https://crm.bigindia.com/login" target="_blank" rel="noopener noreferrer" class="lg:inline-flex lg:w-auto w-auto px-5 py-2 rounded text-gray-500 hover:text-blue-600 hover:underline">Sign in</a>
      </div>
    </div>
